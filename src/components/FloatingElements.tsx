...
const FloatingElements = () => {
  ...
  return (
    <>
      ...
      {/* WhatsApp - above consultation button */}
      <a
        href="https://wa.me/917989259900"
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-[5.5rem] right-6 z-50 w-14 h-14 rounded-full bg-[#25D366] flex items-center justify-center shadow-lg hover:scale-110 transition-transform duration-300 hover:shadow-[0_0_20px_rgba(37,211,102,0.4)]"
