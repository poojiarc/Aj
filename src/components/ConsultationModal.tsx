        ...
        <div className="p-6">
          <AnimatePresence mode="wait">
            ...
            {step === 2 && (
              ...
              >
                <div>
                  <h3 className="font-display text-xl mb-1">A Few Questions</h3>
                  ...
                  {questions.map((q, i) => (
                    <div key={i}>
                      ...
                      <textarea
                        ...
                        rows={2}
                        className="w-full px-3 py-2 rounded-lg bg-secondary border border-border text-foreground focus:outline-none focus:ring-2 focus:ring-primary/50 text-sm resize-none"
                        placeholder="Type your answer..."
                      />
                    </div>
                  ))}
